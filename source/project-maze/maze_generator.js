...
nextLevelButton.onclick = function() {
  ...
  postMessage("Недолго радовалась принцесса... Да-да, снова кошка пропала. Нет, на этот раз Афину никак найти не можем. У вас уже есть опыт в таких делах, мы на Вас очень рассчитываем!");
}
